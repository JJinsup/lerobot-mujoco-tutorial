"""
Deploy trained pi0 policy in simulation with mujoco rendering.
...
def load_policy(device='cuda', checkpoint_path='./ckpt/pi0_omy/checkpoints/last/pretrained_model'):
    """Load trained pi0 policy and dataset metadata."""
    ...
    # Load policy
    policy = PI0Policy.from_pretrained(checkpoint_path, dataset_stats=dataset_metadata.stats)
    policy.to(device)
    policy.eval()
...
def main():
    ...
    CHECKPOINT_PATH = './ckpt/pi0_omy/checkpoints/last/pretrained_model'
